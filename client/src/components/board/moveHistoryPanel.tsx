...
function MoveHistoryPanel(): JSX.Element {
  ...
  return (
    <div className="history-panel flex w-[220px] flex-col rounded-lg border border-gray-700 bg-gray-900 text-gray-200">
      <div className="border-b border-gray-700 px-4 py-2 text-xs font-semibold tracking-wide text-gray-400 uppercase">
        Lịch sử nước đi
      </div>
      <div className="min-h-0 flex-1 overflow-y-auto p-2 font-mono text-sm">
        {pairs.length === 0 ? (
